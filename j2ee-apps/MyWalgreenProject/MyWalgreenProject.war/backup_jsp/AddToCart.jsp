...
<dsp:page>
	...
	<dsp:form action="product.jsp" method="post">
		...
		<dsp:input bean="CartModifierFormHandler.SessionExpirationURL"
			type="hidden" value="../common/session_expired.jsp" />
		...
		<dsp:droplet name="/atg/dynamo/droplet/ForEach">
			...
			<dsp:oparam name="output">
				<table border=0 cellpadding=3 width=100%>
					<tr>
						<td><dsp:input bean="CartModifierFormHandler.catalogRefIds"
							paramvalue="element.repositoryId" type="hidden" /> <span
							class=smallb>Qty</span>&nbsp; <dsp:input
							bean="CartModifierFormHandler.quantity" size="4" type="text"
							value="1" />&nbsp;&nbsp; <dsp:input
							bean="CartModifierFormHandler.addItemToOrder" type="submit"
...
<%-- @version $Id: //product/B2BCommerce/version/9.0/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/catalog/AddToCart.jsp#1 $$Change: 508164 $--%>
