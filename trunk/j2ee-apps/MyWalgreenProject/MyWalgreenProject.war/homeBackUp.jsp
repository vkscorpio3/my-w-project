...
<div id="menu">
<ul>
	<li>Pharmacy & Health <span class="arrow"></span>
	<ul>
		<li class="first"><dsp:a
			href="javascript:ajaxpage('pharmacy/refill_prescription.jsp', 'page');">Refill Prescription</dsp:a></li>
		<li><a
			href="javascript:ajaxpage('pharmacy/new_prescription.jsp', 'page');">New
		Prescription</a></li>
		<li><a
			href="javascript:ajaxpage('pharmacy/transfer_prescription.jsp', 'page');">Transfer
		Prescription</a>
		<li><a
			href="javascript:ajaxpage('pharmacy/health_information.jsp', 'page');">Health
		Information</a>
	</ul>
	</li>
	<li>Photo <span class="arrow"></span>
	<ul>
	...
	<li>Contact Lense <span class="arrow"></span>
	<ul>
	...
	<li>More <span class="arrow"></span>
	<ul>
		<li>Home Health Care Solutions <span class="arrow"></span>
		<ul>
		...
		<li>Services <span class="arrow"></span>
		<ul>
		...
		<li>Diet & Fitness <span class="arrow"></span>
		<ul>
		...
		<li>Baby,Kids & Toys <span class="arrow"></span>
		<ul>
		...
		<li>Household <span class="arrow"></span>
		<ul>
		...
		<li>Grocery <span class="arrow"></span>
		<ul>
		...
		<li>Electronics <span class="arrow"></span>
		<ul>
