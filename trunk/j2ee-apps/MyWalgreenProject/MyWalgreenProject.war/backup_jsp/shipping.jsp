				...
				<table border=1 cellpadding=4 cellspacing=10 width=700
					...
					<tr>
						...
						<dsp:input
							...
							type="text" beanvalue="Profile.firstName" default="First Name" id="shipFirstName" onclick="this.value=''" /></td>
						<td><dsp:input
							bean="Profile.middleName"
							type="text" default="Middle Name" id="shipMiddleName" onclick="this.value=''" /></td>
						<td><dsp:input
							bean="Profile.lastName"
							type="text" default="Last Name" id="shipLastName" onclick="this.value=''" /></td>
					</tr>
				</table>
			</td>
			</tr>
