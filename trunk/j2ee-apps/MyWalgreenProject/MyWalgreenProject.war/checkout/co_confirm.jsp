...
<dsp:page>
	...
	<span class=storelittle> <dsp:a href="../cart.jsp">SHOPPING CART</dsp:a>
	> CHECKOUT </span>
	<p><span class=storebig>Confirm your Order</span><br>
	<span class=help>Make sure everything is correct, and then
	submit your order.</span>
	<p><dsp:include
		page="../../common/DisplayShoppingCartModifierErrors.jsp"></dsp:include>

	<dsp:getvalueof id="form44" bean="/OriginatingRequest.requestURI"
		...
		<dsp:form action="<%=form44%>">
			...
			<table cellspacing=0 cellpadding=0 border=0>
				...
				<tr>
					<td width=200><dsp:img height="1" width="100"
						src="../../images/d.gif" /><br>
					</td>
					<td>&nbsp;&nbsp;</td>
				...
				<tr valign=top>
					<td width=200><span class=help>Please check your order
					one last time, before submitting it. This is the final step.
					<p>If you have made an error, then you may click the
					appropriate link to return to the page to make changes. You will
					not have to reenter correct information.
					</span></td>
					<td></td>
					<td>
					<table width=100% cellpadding=0 cellspacing=0 border=0>
						<tr>
							<td class=box-top-store>Verify my order</td>
						</tr>
					</table>
					<p>
									...
									<dsp:droplet name="Switch">
										...
										<dsp:oparam name="creditCard">
											...
											<dsp:getvalueof id="pval0"
												param="paymentGroup.billingAddress">
			...
			<dsp:valueof param="paymentGroup.creditCardType" />
											<dsp:valueof converter="creditcard"
												param="paymentGroup.creditCardNumber" />
          ...
          No payment
							...
							</dsp:droplet> <!-- End ForEach on payment groups --></td>
							<td colspan=2></td>
						</tr>
							...
							<dsp:oparam name="output">
								...
								<dsp:droplet name="IsEmpty">
									...
									<dsp:oparam name="false">
										...
										<tr valign=top>
											<td colspan=3><dsp:droplet name="Switch">
												<dsp:param name="value"
												...
												<dsp:oparam name="hardgoodShippingGroup">
													...
													<dsp:droplet name="Switch">
														<dsp:param name="value"
															param="ShippingGroup.shippingAddress.ownerId" />

														<!-- If this user "owns" this address, pass in private=false: -->
														<dsp:getvalueof id="nameval3" bean="Profile.id"
															idtype="java.lang.String">
															<dsp:oparam name="<%=nameval3%>">
																<dsp:getvalueof id="pval0"
																	param="ShippingGroup.shippingAddress">
																	<dsp:include page="../../user/DisplayAddress.jsp">
																		<dsp:param name="address" value="<%=pval0%>" />
																		<dsp:param name="private" value="false" />
																	</dsp:include>
														...
														<dsp:oparam name="default">
															<dsp:getvalueof id="pval0"
																...
																<dsp:include page="../../user/DisplayAddress.jsp">
																	<dsp:param name="address" value="<%=pval0%>" />
																	<dsp:param name="private" value="true" />
																</dsp:include>
															</dsp:getvalueof>
														</dsp:oparam>
													</dsp:droplet>
    ...
    ( <dsp:valueof converter="currency"
														param="ShippingGroup.PriceInfo.amount" /> )<br>
												</dsp:oparam>
											...
											</dsp:droplet> <!-- End switch on type of shipping Group --></td>
											<td colspan=2></td>
										</tr>
											...
											<dsp:oparam name="output">
												<tr valign=top>
													<td align=right><dsp:valueof
														param="CiRelationship.Quantity" /></td>
													<td></td>
													<td><i><dsp:valueof
														param="CiRelationship.CommerceItem.auxiliaryData.productRef.displayName" /></i></td>
													<td></td>
													<td align=right></td>
												</tr>
...
No items in the cart!
				...
				<tr valign=top>
					<td><span class=help>This is it!</span>
					<p>
					</td>
					<td></td>
					<td><!------------------------------------------------------------------->
      ...
      */%> <%
      ...
      %> <dsp:droplet name="/atg/dynamo/droplet/ProtocolChange">
						...
						<dsp:oparam name="output">
							<dsp:input
								bean="ShoppingCartModifier.moveToOrderCommitSuccessURL"
								paramvalue="nonSecureUrl" type="hidden" />
						</dsp:oparam>
					</dsp:droplet> <!-- Location to go to on order error --> <dsp:input
						bean="ShoppingCartModifier.moveToOrderCommitErrorURL"
						type="hidden" value="co_confirm.jsp" /> <!-- Go to this URL if user's session expired while he pondered this page -->
					<dsp:input bean="ShoppingCartModifier.sessionExpirationURL"
						type="hidden" value="../../common/SessionExpired.jsp" />

					<table width=100% cellpadding=0 cellspacing=0 border=0>
						<tr>
							<td class=box-top-store>Place my order</td>
						</tr>
					</table>
					<p>You may fix any errors now.
					<p>> <dsp:a href="../cart.jsp">return to shopping cart</dsp:a><br>
					...
					<p>Clicking below will place your order.
					<p><dsp:input bean="ShoppingCartModifier.MoveToOrderCommit"
