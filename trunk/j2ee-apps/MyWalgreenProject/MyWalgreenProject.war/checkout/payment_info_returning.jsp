	...
	<p><dsp:form action="co_confirm.jsp" method="post">
		<table cellspacing=0 cellpadding=0 border=1 bgcolor="#B0C4DE">
			...
			<tr valign=top>
				...
				<dsp:droplet name="ForEach">
					...
					<dsp:oparam name="output">
						<dsp:droplet name="Switch">
							...
							<dsp:oparam name="1">
								<dsp:input bean="ShoppingCartModifier.selectedCreditCardName"
				...
				</dsp:droplet> <dsp:droplet name="ForEach">
						...
						<table border=1 cellpadding=4 cellspacing=10 width=700
							...
							<tr>
								<td colspan="2"><dsp:input
									bean="ShoppingCartModifier.selectedCreditCardName"
							...
							<tr>
								...
								<table border="2" cellspacing="5" bgcolor="#F5F5DC">
									<tr>
										<td>Card Type</td>
										<td><dsp:select
											bean="ShoppingCartModifier.creditCardPaymentGroups[0].creditCardType"
											required="<%=true%>">
									...
									<tr>
										...
										<td><dsp:input
											bean="ShoppingCartModifier.creditCardPaymentGroups[0].creditCardNumber"
											maxlength="16" size="20" type="text" /></td>
									</tr>
									<tr>
										<td>Expiration Date</td>
										<td>Month: <dsp:select
											bean="ShoppingCartModifier.creditCardPaymentGroups[0].expirationMonth">
										...
										<dsp:option value="12" />December
											...
											bean="ShoppingCartModifier.creditCardPaymentGroups[0].expirationYear">
				...
				</dsp:droplet> <!--<p>If you have gift certificates, type their codes below<br>
				<dsp:input bean="ShoppingCartModifier.giftCertificateNumbers"
					size="50" type="text" value="" />
				--> <!-- Location to go to on success --></td>
			</tr>
		</table>
	</dsp:form></p>
</dsp:page></center>
