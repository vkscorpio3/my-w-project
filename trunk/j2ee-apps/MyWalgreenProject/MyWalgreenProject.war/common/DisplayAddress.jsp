...
%>
	...
	<DECLAREPARAM NAME="address" CLASS="java.lang.Object"
		DESCRIPTION="A ContactInfo Repository Item to display">


	<table cellspacing=0 cellpadding=0 broder=0>
		<tr>
			<td><nobr><dsp:valueof param="address.companyName" /></nobr><br>
			...
			</dsp:droplet> <dsp:droplet name="Switch">
...
<%-- @version $Id: //product/B2BCommerce/version/9.0/release/MotorpriseJSP/j2ee-apps/motorprise/web-app/en/common/DisplayAddress.jsp#1 $$Change: 508164 $--%>
